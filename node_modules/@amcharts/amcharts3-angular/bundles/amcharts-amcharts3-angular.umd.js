(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@amcharts/amcharts3-angular', ['exports', '@angular/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.amcharts = global.amcharts || {}, global.amcharts["amcharts3-angular"] = {}), global.ng.core));
    ...
    var AmChartsService = /** @class */ (function () {
        ...
        AmChartsService.prototype.formatNumber = function (value, formatter, zeroCount) {
            // TODO use this.zone.runOutsideAngular ?
            return AmCharts.formatNumber(value, formatter, zeroCount);
        };
        AmChartsService.prototype.stringToDate = function (value, format) {
            // TODO use this.zone.runOutsideAngular ?
    ...
    AmChartsService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsService, deps: [{ token: i0__namespace.NgZone }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    AmChartsService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    AmChartsDirective.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsDirective, deps: [{ token: i0__namespace.ElementRef }, { token: AmChartsService }, { token: i0__namespace.NgZone }], target: i0__namespace.ɵɵFactoryTarget.Directive });
    AmChartsDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.2.11", type: AmChartsDirective, selector: "amCharts", inputs: { id: "id", options: "options", delay: "delay" }, usesOnChanges: true, ngImport: i0__namespace });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsDirective, decorators: [{
                type: i0.Directive,
                args: [{
                        selector: 'amCharts'
                    }]
            }], ctorParameters: function () { return [{ type: i0__namespace.ElementRef }, { type: AmChartsService }, { type: i0__namespace.NgZone }]; }, propDecorators: { id: [{
                    type: i0.Input
                }], options: [{
                    type: i0.Input
                }], delay: [{
    ...
    AmChartsModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    AmChartsModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsModule, declarations: [AmChartsDirective], exports: [AmChartsDirective] });
    AmChartsModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsModule, providers: [
            AmChartsService
        ] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.11", ngImport: i0__namespace, type: AmChartsModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        declarations: [
                            AmChartsDirective
...
//# sourceMappingURL=amcharts-amcharts3-angular.umd.js.map
